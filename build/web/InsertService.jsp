<%-- 
    ...
    Created on : Aug 17, 2019, 3:15:46 PM
                                ...
                                <div class="row mb-4">
                                 ...
                                 <div class="row mb-4">
                                    <div class="col-md-12 form-group">
                                        ...
                                        <input type="file" name="txtImg" value="" id="message" class="form-control" cols="30" rows="8"/>                                      
                                    </div>
                                 </div>
                                <div class="row">
                                    <div class="col-md-6 form-group">         
                                        <input type="submit" value="Insert Service" name="btnAction" class="btn btn-primary text-white py-3 px-5 font-weight-bold">
                                    </div>
                                </div>
                            </form>
                        </div>
