<%-- 
    Document   : UpdateFood
    Created on : Aug 20, 2019, 4:22:53 PM
                    ...
                    <div class="col-md-7" data-aos="fade-up" data-aos-delay="100">
                        <div class="bg-white p-md-5 p-4 mb-5 border">
                            <form action="MainController" method="POST">
                                <c:set var="dto" value="${requestScope.FOODDTO}"/>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 form-group">
                                        ...
                                        <c:if test="${not empty error}">
                                            <font style="color: red">${error.nameError}</font>
                                        </c:if>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 form-group">
                                        <label class="text-black font-weight-bold" for="name">FOOD PRICE</label>
                                        <input type="number" step="0.01" id="name" name="txtPrice" value="${dto.price}" class="form-control" required=""/>
                                        <c:if test="${not empty error}">
                                            <font style="color: red">${error.priceError}</font>
                                        </c:if>
                                    </div>
                                    <div class="col-md-6 form-group">
                                        <label class="text-black font-weight-bold" for="phone">Quantity</label>
                                        <input type="number" id="phone" name="txtQuantity" value="${dto.quantity}" class="form-control" required=""/>
                                        <c:if test="${not empty error}">
                                ...
                                <div class="row">
                                    <div class="col-md-6 form-group">
                                        <input type="submit" value="Update Food" name="btnAction" class="btn btn-primary text-white py-3 px-5 font-weight-bold"/>
                                    </div>
                                </div>
                            </form>
                        </div>
