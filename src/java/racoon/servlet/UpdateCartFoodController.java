 ...
 */
public class UpdateCartFoodController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int quanti = Integer.parseInt(request.getParameter("txtQuantityFood"));
            shoppingCart.updateCart(id, quanti);
            session.setAttribute("CARTFOOD", shoppingCart);

        } catch (Exception e) {
            log("Error at UpdateCartFoodController" + e.getMessage());
